...
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _sgxGethVerifier, address _tdxNethermindVerifier, address _azureTdxNethermindVerifier, address _risc0RethVerifier, address _sp1RethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sgxRethVerifier common.Address, _sgxGethVerifier common.Address, _tdxNethermindVerifier common.Address, _azureTdxNethermindVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.contract.Transact(opts, "init", _owner, _sgxRethVerifier, _sgxGethVerifier, _tdxNethermindVerifier, _azureTdxNethermindVerifier, _risc0RethVerifier, _sp1RethVerifier)
}

// Init is a paid mutator transaction binding the contract method 0xf0d4d592.
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _sgxGethVerifier, address _tdxNethermindVerifier, address _azureTdxNethermindVerifier, address _risc0RethVerifier, address _sp1RethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierSession) Init(_owner common.Address, _sgxRethVerifier common.Address, _sgxGethVerifier common.Address, _tdxNethermindVerifier common.Address, _azureTdxNethermindVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.Contract.Init(&_SurgeVerifier.TransactOpts, _owner, _sgxRethVerifier, _sgxGethVerifier, _tdxNethermindVerifier, _azureTdxNethermindVerifier, _risc0RethVerifier, _sp1RethVerifier)
}

// Init is a paid mutator transaction binding the contract method 0xf0d4d592.
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _sgxGethVerifier, address _tdxNethermindVerifier, address _azureTdxNethermindVerifier, address _risc0RethVerifier, address _sp1RethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierTransactorSession) Init(_owner common.Address, _sgxRethVerifier common.Address, _sgxGethVerifier common.Address, _tdxNethermindVerifier common.Address, _azureTdxNethermindVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.Contract.Init(&_SurgeVerifier.TransactOpts, _owner, _sgxRethVerifier, _sgxGethVerifier, _tdxNethermindVerifier, _azureTdxNethermindVerifier, _risc0RethVerifier, _sp1RethVerifier)
}
