...
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _tdxRethVerifier, address _risc0RethVerifier, address _sp1RethVerifier, address _sgxGethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierTransactor) Init(opts *bind.TransactOpts, _owner common.Address, _sgxRethVerifier common.Address, _tdxRethVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address, _sgxGethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.contract.Transact(opts, "init", _owner, _sgxRethVerifier, _tdxRethVerifier, _risc0RethVerifier, _sp1RethVerifier, _sgxGethVerifier)
}

// Init is a paid mutator transaction binding the contract method 0x99e133f9.
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _tdxRethVerifier, address _risc0RethVerifier, address _sp1RethVerifier, address _sgxGethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierSession) Init(_owner common.Address, _sgxRethVerifier common.Address, _tdxRethVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address, _sgxGethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.Contract.Init(&_SurgeVerifier.TransactOpts, _owner, _sgxRethVerifier, _tdxRethVerifier, _risc0RethVerifier, _sp1RethVerifier, _sgxGethVerifier)
}

// Init is a paid mutator transaction binding the contract method 0x99e133f9.
//
// Solidity: function init(address _owner, address _sgxRethVerifier, address _tdxRethVerifier, address _risc0RethVerifier, address _sp1RethVerifier, address _sgxGethVerifier) returns()
func (_SurgeVerifier *SurgeVerifierTransactorSession) Init(_owner common.Address, _sgxRethVerifier common.Address, _tdxRethVerifier common.Address, _risc0RethVerifier common.Address, _sp1RethVerifier common.Address, _sgxGethVerifier common.Address) (*types.Transaction, error) {
	return _SurgeVerifier.Contract.Init(&_SurgeVerifier.TransactOpts, _owner, _sgxRethVerifier, _tdxRethVerifier, _risc0RethVerifier, _sp1RethVerifier, _sgxGethVerifier)
}
