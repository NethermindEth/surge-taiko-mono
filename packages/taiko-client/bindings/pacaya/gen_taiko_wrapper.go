...
//
// Solidity: function proposeBatch(bytes _params, bytes _txList) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint64)), (bytes32,address,uint64,uint64))
