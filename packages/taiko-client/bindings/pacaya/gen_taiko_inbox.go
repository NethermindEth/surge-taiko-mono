...
//
// Solidity: function proposeBatch(bytes _params, bytes _txList) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint64)) info_, (bytes32,address,uint64,uint64) meta_)
...
// FilterBatchProposed is a free log retrieval operation binding the contract event 0xec72b186bdd1d980c2e209ac0d300abe00927161504d5385d30ce108aca87b03.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint64)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// WatchBatchProposed is a free log subscription operation binding the contract event 0xec72b186bdd1d980c2e209ac0d300abe00927161504d5385d30ce108aca87b03.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint64)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// ParseBatchProposed is a log parse operation binding the contract event 0xec72b186bdd1d980c2e209ac0d300abe00927161504d5385d30ce108aca87b03.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint64)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
