...
type ITaikoInboxBatchInfo struct {
	...
	GasLimit           uint32
	BaseFee            *big.Int
	CelestiaBlobParams ITaikoInboxCelestiaBlobParams
	LastBlockId        uint64
	LastBlockTimestamp uint64
	AnchorBlockId      uint64
...
// ITaikoInboxCelestiaBlobParams is an auto generated low-level Go binding around an user-defined struct.
type ITaikoInboxCelestiaBlobParams struct {
	Height    uint64
	Namespace []byte
}
...
//
// Solidity: function proposeBatch(bytes _params, bytes _txList) returns((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint32)) info_, (bytes32,address,uint64,uint64) meta_)
...
// FilterBatchProposed is a free log retrieval operation binding the contract event 0xb397c7a1a5e85e355a845d65370b7dbb7517c546bdd1f70c13a244df87c3bebc.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// WatchBatchProposed is a free log subscription operation binding the contract event 0xb397c7a1a5e85e355a845d65370b7dbb7517c546bdd1f70c13a244df87c3bebc.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
...
// ParseBatchProposed is a log parse operation binding the contract event 0xb397c7a1a5e85e355a845d65370b7dbb7517c546bdd1f70c13a244df87c3bebc.
//
// Solidity: event BatchProposed((bytes32,(uint16,uint8,bytes32[])[],bytes32[],bytes32,address,uint64,uint64,uint32,uint32,uint32,uint96,(uint64,bytes),uint64,uint64,uint64,bytes32,(uint8,uint8,uint32,uint64,uint32)) info, (bytes32,address,uint64,uint64) meta, bytes txList)
