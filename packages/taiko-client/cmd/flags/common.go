...
var (
	...
	GenesisL1Height = &cli.Uint64Flag{
		...
		Usage:    "L1 block height of the L2 genesis (required for shasta and realtime forks). For realtime, this is the L1 block where the RealTimeInbox was activated.",
		Value:    0,
		Category: commonCategory,
