...
var (
	...
	ZKVMProofType1 = &cli.StringFlag{
		...
		Usage:    "Proof type for the first ZKVM (risc0, sp1, or zisk, must differ from proofType2)",
		Required: true,
		Category: proverCategory,
	...
	ZKVMProofType2 = &cli.StringFlag{
		...
		Usage:    "Proof type for the second ZKVM (risc0, sp1, or zisk, must differ from proofType1)",
		Required: true,
		Category: proverCategory,
