...
export VERBOSITY=3
export OWNER_MULTISIG_SIGNERS="0x1670010000000000000000000000000000000002,0x1670010000000000000000000000000000000003,0x1670010000000000000000000000000000000004"
export OWNER_MULTISIG=0x1670010000000000000000000000000000000001
export TIMELOCK_PERIOD=3888000
export VERIFIER_OWNER=0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
export L2_CHAINID=167001
...
VERBOSITY=$VERBOSITY
OWNER_MULTISIG_SIGNERS=$OWNER_MULTISIG_SIGNERS
OWNER_MULTISIG=$OWNER_MULTISIG
TIMELOCK_PERIOD=$TIMELOCK_PERIOD
VERIFIER_OWNER=$VERIFIER_OWNER" > integration_test/.env
