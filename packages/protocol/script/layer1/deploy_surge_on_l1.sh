...
## Addresses are dummy. Please change them before deploying.
...
ATTESTATION_CONTRACT_OWNER=0x1237810000000000000000000000000000000001 \
RISC0_VERIFIER_OWNER=0x1237810000000000000000000000000000000001 \
