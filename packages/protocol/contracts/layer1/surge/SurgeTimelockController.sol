...
contract SurgeTimelockedController is TimelockController {
    ...
    function updateMinLivenessStreak(uint64 _minLivenessStreak)
        external
    ...
    function _isLivenessDisrupted() internal view returns (bool) {
        uint256 verificationStreakStartedAt = taikoInbox.getVerificationStreakStartAt();
