...
export function FullDisclaimer({ isOpen, onClose }: FullDisclaimerProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-surge-primary/70 backdrop-blur-sm flex items-center justify-center z-[60]">
      <div className="bg-surge-card border border-surge-border rounded-2xl w-full max-w-2xl mx-4 shadow-2xl shadow-surge-primary/20 max-h-[85vh] flex flex-col">
        <div className="p-6 pb-0">
          <h2 className="text-xl font-bold text-surge-text">Surge Realtime Alpha - Experimental Software Disclaimer</h2>
        </div>

        <div className="p-6 overflow-y-auto space-y-4 text-sm text-surge-muted leading-relaxed">
          <p>
            <strong className="text-surge-text">Please read this disclaimer carefully before using the Surge Realtime Alpha ("the Alpha").</strong> By interacting with any component of the Alpha (including the bridge, explorer, DEX, or RPC), you acknowledge that you have read, understood, and accepted the terms described below.
          </p>

          <div>
            <h3 className="text-surge-text font-semibold mb-1">What the Alpha Is</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">Risks</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">Who Should Use This</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">No Warranties</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">No Liability</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">Regulatory Status</h3>
            <p>
          ...
          <div>
            <h3 className="text-surge-text font-semibold mb-1">Changes and Termination</h3>
            <p>
        ...
        <div className="p-6 pt-4 border-t border-surge-border">
          <button
            onClick={onClose}
            className="w-full py-3 bg-surge-primary hover:opacity-90 text-white rounded-lg font-medium transition-opacity shadow-sm"
          >
            Close
          </button>
        </div>
